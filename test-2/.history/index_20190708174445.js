...
function loadRes(cb) {
  resources.score = loadImg('https://wbpmrck.github.io/animation-study/cases/do-not-click-white-block/img/score-bg.png', () => {
    resources.start = loadImg('https://wbpmrck.github.io/animation-study/cases/do-not-click-white-block/img/start.png', () => {
      cb && cb();
    })
  })
}
...
var config = {
  clock: 200, // 控制动画帧率。如果是undefined,默认requestAnimationFrame，否则使用计时器(duration=clock)
  canvas: {
    width: 0,
    height: 0,
